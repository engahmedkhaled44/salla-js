...
const changeName = { companyName: "شركة تاك", companyUrl: "https://agencytak.com" };
...
/*اضافه فيديو مكتن السلايدر او الصور */
...
// تحويل الصوره الي لينك 

const gifImg = document.querySelector('.gif.shadow-gif-product');
gifImg.addEventListener("click", () => {
    window.location.href = "https://google.com";
})


// اضافه ايقونات سوشيال ميديا في الفوتر
if (window.matchMedia("(min-width: 992px)").matches) {
    const socialDiv = document.createElement("div");
        socialDiv.innerHTML = `<salla-social class="mb-6 s-social-list hydrated"><li class="s-social-link"><a href="https://www.instagram.com/vivid_avenue1" rel="noopener" target="_blank" title="instagram" aria-label="instagram"><span class="s-social-icon"><!-- Generated by IcoMoon.io -->
    ...
    </span></a></li><li class="s-social-link"><a href="https://www.snapchat.com/add/vividavenue1" rel="noopener" target="_blank" title="snapchat" aria-label="snapchat"><span class="s-social-icon"><!-- Generated by IcoMoon.io -->
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
    ...
    </span></a></li><li class="s-social-link"><a href="https://www.tiktok.com/@vividavenue1" rel="noopener" target="_blank" title="tiktok" aria-label="tiktok"><span class="s-social-icon"><!-- Generated by IcoMoon.io -->
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
    <title>tiktok</title>
    ...
    </span></a></li></salla-social>`;
    
    document.querySelector("footer .grid > div:nth-child(3)").appendChild(socialDiv);}



    //تغيير الفيديو في الموبايل بدون ما نحمل الصفحه كل مره 
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateVideo(e) {
    if (e.matches) {
      video.src = "https://github.com/wpAzzrk/hag-ahmed-bokha/raw/refs/heads/main/WhatsApp%20Video%202025-09-01%20at%2012.36.34%20PM.mp4"; 
    }//لينك الفيديو في الموبايل 
     else {
      video.src = "https://github.com/wpAzzrk/hag-ahmed-bokha/raw/refs/heads/main/0_Skincare_Beauty_1920x1080.mp4.mp4"; 
    }//لينك الفيديو في الديسكتوب
    video.load();
    video.play();
  }
